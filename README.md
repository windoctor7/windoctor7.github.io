...
| [spring5-reactive-kotlin](https://github.com/windoctor7/codigo-tutoriales-blog/tree/master/spring5-reactive-kotlin)  | En este tutorial aprenderemos como hacer una búsqueda con autocompletado reactivo utilizando Kotlin y Spring Boot 2 en el back-end y RxJS en el front-end.  |